...
SECRET_KEY = 'django-insecure-let5asf(i@vqvl+eo67dw*1lnq4ypyy-+da=xlve#o3g+zona%'
...
AUTH_USER_MODEL = 'customer.UserTable'
...
AUTHENTICATION_BACKENDS = [
    'customer.authentication.LowercaseEmailBackend',
]
